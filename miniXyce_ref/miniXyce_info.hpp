...
#define MINIXYCE_CXXFLAGS "'-O3 -funroll-all-loops  -DBRANCH_HINT=1 -DPRINT_OUTPUT=0 -DCOUNT_QUEUE_DESYNC=0 -DVAR_GROUPING=1 -DAPPROACH_USING_POINTERS=0 -DAPPROACH_ALREADY_CONSUMED=0 -DAPPROACH_NEW_LIMIT=1 -DAPPROACH_WRITE_INVERTED_NEW_LIMIT=0 -DAPPROACH_NEW_ENQ_INDEX=0'"
