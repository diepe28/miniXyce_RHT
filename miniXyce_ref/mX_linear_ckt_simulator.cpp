...
int main(int argc, char* argv[]) {
    ...
    int num_internal_nodes2, num_voltage_sources2, num_inductors2;
    ...
    if (replicated || true) {
        ...
        main_execution_replicated(p, pid, n, sim_start, doc, ckt_netlist_filename, t_start, t_step, t_stop, tol, res, k, iters,
