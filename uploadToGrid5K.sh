...
#cd public/ && tar -xzvf miniXyce_RHT-master.tar.gz && rm miniXyce_RHT-master.tar.gz && cd miniXyce_RHT-master/cmake-build-debug/ && cmake .. && make
...
if [ 1 -eq 0 ]; then
# there are these the test files, in ascending order
# cirBig.net
# cirHugeSmall.net 
# cirHuge.net 
